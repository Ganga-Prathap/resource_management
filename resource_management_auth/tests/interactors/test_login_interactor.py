...
def test_login_with_invalid_username_raise_exception():
    ...
    #Assert
    storage.validate_username.assert_called_with(
        username=username
    )
...
def test_login_with_invalid_password_raise_exception():
    ...
    storage.validate_password.assert_called_with(
        username=username,
        password=password
    )
...
def test_login_with_valid_details(create_user_auth_tokens_mock):
    ...
    storage.is_user_admin_or_not.assert_called_with(user_id=user_id)
