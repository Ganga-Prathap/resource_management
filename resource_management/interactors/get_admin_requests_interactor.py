...
from resource_management.interactors.presenters.presenter_interface import \
    PresenterInterface
from resource_management.adapters.service_adapter import get_service_adapter
...
class GetAdminRequestsInteractor:
    ...
    def get_admin_requests(self, user_id: int,
        ...
        for request_dto in requests_dto:
            userdto = service_adapter.auth_service.get_user_details(
                request_dto.user_id
            )
